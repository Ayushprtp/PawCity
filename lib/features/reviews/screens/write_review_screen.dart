    ...
    return PawScaffold(
      ...
      body: SingleChildScrollView(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        PawAsymCard(
          ...
          child: Row(children: [
            Container(width: 48, height: 48, decoration: BoxDecoration(color: AppColors.vet.withValues(alpha: 0.12), borderRadius: BorderRadius.circular(AppSizes.radiusMd)), child: const Icon(Icons.local_hospital_rounded, color: AppColors.vet)),
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('Veterinary Clinic', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: AppColors.onSurfaceVariant)),
            ])),
          ]),
        ),
          ...
          GestureDetector(
            ...
            child: Padding(
              ...
              child: AnimatedScale(
                ...
                child: Icon(i < _rating ? Icons.star_rounded : Icons.star_outline_rounded, size: 44, color: i < _rating ? AppColors.amber : AppColors.outlineVariant),
              ),
            ),
          ),
        ))),
        ...
        Center(child: Text(
          ...
          style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: _rating > 0 ? AppColors.amber : AppColors.onSurfaceVariant),
        )),
        const SizedBox(height: AppSizes.sectionGap),
        ...
        Container(
          ...
          decoration: BoxDecoration(border: Border.all(color: AppColors.outlineVariant, width: 1.5), borderRadius: BorderRadius.circular(AppSizes.radiusMd), color: AppColors.surfaceContainerLow),
          child: InkWell(onTap: () {}, child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            const Icon(Icons.add_a_photo_rounded, size: 28, color: AppColors.outline),
            const SizedBox(height: AppSizes.xs),
            Text('Tap to add photos', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: AppColors.outline)),
          ])),
        ),
        const SizedBox(height: AppSizes.sectionGap),
