        ...
        data: (alerts) {
          if (alerts.isEmpty) {
            return Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
              Container(padding: const EdgeInsets.all(AppSizes.xl), decoration: BoxDecoration(color: AppColors.errorContainer.withValues(alpha: 0.2), shape: BoxShape.circle), child: const Icon(Icons.pets_rounded, size: 48, color: AppColors.error)),
              ...
              return PawAsymCard(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Row(children: [
                    ...
                    PawStatusBadge(label: a.isFound ? 'Found' : 'Missing', color: a.isFound ? AppColors.severityLow : AppColors.error),
                  ]),
                  const SizedBox(height: AppSizes.xs),
                  Text('${a.petType.label}${a.petBreed != null ? ' · ${a.petBreed}' : ''}', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: AppColors.onSurfaceVariant)),
                  const SizedBox(height: AppSizes.sm),
                  ...
                  Row(children: [
                    ...
                    Expanded(child: Text(a.lastSeenAddress ?? 'Location reported', style: Theme.of(context).textTheme.labelSmall?.copyWith(color: AppColors.outline))),
                    if (a.createdAt != null) Text(timeago.format(a.createdAt!), style: Theme.of(context).textTheme.labelSmall?.copyWith(color: AppColors.outline)),
                  ]),
                  if (a.rewardAmount != null && a.rewardAmount! > 0) ...[
                    ...
                    Container(
                      ...
                      child: Text('Reward: ₹${a.rewardAmount!.toStringAsFixed(0)}', style: Theme.of(context).textTheme.labelMedium?.copyWith(fontWeight: FontWeight.w700, color: AppColors.onSurface)),
                    ),
                  ],
                ]),
              );
